...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎来到小坤聊天室，请遵守聊天室规则，并使文明用语。</span><br><span style='line-height:22px;'>";
	...
	function check() {
		$.post("${pageContext.request.contextPath}/LoginServlet?method=check",function(data){
			if(data == 1){
				alert("用户已被提下线！");
	...
	function showContent(){
		$.post("${pageConetext.request.contextPath}/LoginServlet?"+new Date().getTime(),{'method':'getMessage'},function(data){
	...
	function send() {
		...
		$.post("${pageContent.request.contextPath}/LoginServlet?"+new Date().getTime(),$("#form1").serialize(),function(data){
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<td colspan="2" align="center" class="word_dark">&nbsp;All
					CopyRights reserved 2018陕西科技大学</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
	</table>
